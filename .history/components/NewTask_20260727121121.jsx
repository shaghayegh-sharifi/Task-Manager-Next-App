        ...
        <div className='relative p-4 w-full max-w-md max-h-full'>
          ...
          <div className='relative bg-neutral-primary-soft border border-default rounded-base shadow-sm p-4 md:p-6'>
            ...
            <div className='flex items-center justify-between border-b border-default pb-4 md:pb-5'>
              <h3 className='text-lg font-medium text-heading'>Create new product</h3>
              <button
                type='button'
            ...
            <form action='#'>
              <div className='grid gap-4 grid-cols-2 py-4 md:py-6'>
                <div className='col-span-2'>
                  <label for='name' className='block mb-2.5 text-sm font-medium text-heading'>
                    Name
                  </label>
                  <input
                    type='text'
                ...
                <div className='col-span-2 sm:col-span-1'>
                  <label for='price' className='block mb-2.5 text-sm font-medium text-heading'>
                    Price
                  </label>
                  <input
                    type='number'
                ...
                <div className='col-span-2 sm:col-span-1'>
                  <label for='category' className='block mb-2.5 text-sm font-medium text-heading'>
                    Category
                  </label>
                  <select
                    id='category'
                ...
                <div className='col-span-2'>
                  <label for='description' className='block mb-2.5 text-sm font-medium text-heading'>
                    Product Description
                  </label>
                  <textarea
                    id='description'
