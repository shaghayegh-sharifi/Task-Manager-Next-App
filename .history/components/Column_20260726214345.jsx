    ...
    <div className='w-80 flex-shrink-0 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-3xl p-4'>
      <div className='flex items-center justify-between mb-4'>
        <div className='flex items-center'>
          ...
          {isEditing ? (
            <input
              className='w-full border border-slate-200 dark:border-slate-600 p-1 rounded focus:outline-none focus:ring focus:border-slate-300 dark:focus:border-slate-50 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100'
              value={title}
