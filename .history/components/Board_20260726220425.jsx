        ...
        <div className='flex flex-nowrap overflow-x-auto space-x-6'>
          ...
          <div className='w-80 flex-shrink-0 bg-indigo-50 dark:bg-indigo-900 border border-indigo-200 dark:border-indigo-700 rounded-3xl p-4 shadow-md flex flex-col'>
            ...
            <input
              ...
              className='w-full border border-indigo-200 dark:border-indigo-600 p-2 rounded-2xl focus:outline-none focus:ring focus:ring-indigo-300 dark:focus:ring-indigo-500 mb-4 bg-white dark:bg-gray-800 text-slate-800 dark:text-slate-100'
            />
