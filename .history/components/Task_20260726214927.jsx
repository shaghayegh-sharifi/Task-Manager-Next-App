...
export default function Task({ task, columnId, onDeleteTask, onEditTask }) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className='p-3 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-700 rounded-md shadow-sm mb-3 flex items-center transition-transform duration-150 hover:shadow-lg'>
      {/* Drag handle */}
