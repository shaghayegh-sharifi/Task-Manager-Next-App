    ...
    <div className='w-80 flex-shrink-0 bg-slate-50 dark:bg-gray-900 border border-slate-200 dark:border-gray-700 rounded-3xl p-4'>
      ...
      <div className='mt-4'>
        <input
          ...
          className='w-full border border-slate-200 dark:border-gray-600 px-4 py-2 rounded focus:outline-none focus:ring focus:border-blue-300 dark:focus:border-blue-500 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100'
        />
