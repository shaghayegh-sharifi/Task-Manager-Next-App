        ...
        <div className='flex flex-nowrap overflow-x-auto space-x-6'>
          ...
          <div className='w-80 flex-shrink-0 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg p-4 shadow-md flex flex-col'>
            ...
            <input
              ...
              className='w-full border border-indigo-200 dark:border-green-600 p-2 rounded focus:outline-none focus:ring focus:border-green-300 dark:focus:border-green-500 mb-4 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100'
            />
            <button onClick={handleAddColumn} className='w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded transition-colors'>
              Add Column
            </button>
          </div>
        </div>
