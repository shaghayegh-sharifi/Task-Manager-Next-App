    ...
    <DndContext sensors={sensors} collisionDetection={closestCenter} onDragStart={handleDragStart} onDragEnd={handleDragEnd}>
      <SortableContext items={data.columnOrder} strategy={horizontalListSortingStrategy}>
        <div className='flex flex-nowrap overflow-x-auto space-x-6'>
          ...
          {/* Add Column UI */}
          <div className='w-80 flex-shrink-0 bg-indigo-50 dark:bg-indigo-900 border border-indigo-200 dark:border-indigo-700 rounded-lg p-4 shadow-md flex flex-col'>
