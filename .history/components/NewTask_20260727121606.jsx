          ...
          <div className='relative bg-neutral-primary-soft border border-default rounded-base shadow-sm p-4 md:p-6'>
            ...
            <form action='#'>
              <div className='grid gap-4 grid-cols-2 py-4 md:py-6'>
                ...
                <div className='col-span-2 sm:col-span-1'>
                  <label htmlFor='category' className='block mb-2.5 text-sm font-medium text-heading'>
                    Category
                  </label>
                  <select
                    id='category'
              ...
              <div className='flex items-center space-x-4 border-t border-default pt-4 md:pt-6'>
                <button
                  ...
                  <svg className='w-4 h-4 me-1.5 -ms-0.5' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='none' viewBox='0 0 24 24'>
                    <path stroke='currentColor' strokeinecap='round' stroke-linejoin='round' stroke-width='2' d='M5 12h14m-7 7V5' />
                  </svg>
                  Add new product
                </button>
                <button
